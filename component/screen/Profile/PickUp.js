...
import { Text, StyleSheet, View, FlatList, Image, TouchableOpacity, TextInput, ScrollView ,Alert} from 'react-native'
import { Container, Header,Body , Right, Icon, Picker,Button} from 'native-base'
                ...
                <Container style={{backgroundColor: '#F9F9F9'}}>
                    ...
                    <ScrollView>
                        <View style={styles.AllDataVal}>
                            ...
                            <View style={{marginBottom:10}}>
                                ...
                                <View style={{borderWidth:2, borderColor:'#fff', backgroundColor:'#fff', paddingHorizontal:10}}>
                                    <Picker
                                        ...
                                        <Picker.Item key='k' label={this.state.settings.select_pickup_location} value='' />
                                        {
                                            this._getpickupData()
                                        }
                                    </Picker>
                            ...
                            <View style={{flexDirection:'row',marginBottom:10,width:'92%', 
        marginLeft:'4%',}}>
                            ...
                            <View style={{marginBottom:10,width:'92%', 
        marginLeft:'4%'}}>
                                <View style={{marginBottom:8}}>
