...
export default class ViewBooking extends Component {
    ...
    _getHeadInfoData = () => {
        if(this.state.searchdataInfo == ''){
          ...
          const routeName =<View style={[styles.searchtour,{flexDirection:'row'}]}>
                              <View style={{flex:2}}>
                                  <Button transparent onPress={()=> this.props.navigation.navigate('BookingList')}>
    ...
    _GetBooking = ()=>{
        if(this.state.Data == ''){
            ...
            return  <View style={styles.AllDataVal}>
                        <View style={styles.departureView}>
                            <View style={styles.depCont}>
                                <Text style={styles.depText}>Name</Text>
                            </View>
                            <View style={{flex:1}}>
                                <Text style={styles.firstTextVal}>{this.state.Data.firstname}</Text>
                            </View>
                        </View>
                        <View style={styles.departureView}>
                            <View style={styles.depCont}>
                        ...
                        <View style={styles.departureView}>
                            ...
                            <View style={{flex:1}}>
                                <Text style={styles.firstTextVal}>{this.state.Data.pickup_trip_location}</Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.departureView}>
                            ...
                            <View style={{flex:1}}>
                                <Text style={styles.firstTextVal}>{this.state.Data.drop_trip_location}</Text>
                            </View>
                        </View>
                        <View style={styles.departureView}>
                            <View style={styles.depCont}>
                        ...
                        <View style={styles.departureView}>
                            ...
                            <View style={{flex:1}}>
                                <Text style={styles.firstTextVal}>{this.state.Data.discount == null ? 'Not Any':this.state.Data.discount}</Text>
                            </View>
                        </View>
                        <View style={styles.departureView}>
                            <View style={styles.depCont}>
                            ...
                            <View style={{flex:1}}>
                            <Text style={styles.firstTextVal}>{this.state.Data.request_facilities}</Text>
                            </View>
                        </View>
                        <View style={styles.departureView}>
                            <View style={styles.depCont}>
                        ...
                        <View style={[styles.departureView,]}>
                            ...
                            <View style={{flex:1}}>
                                <Text style={styles.firstTextVal}>{this.state.Data.adult == "0" ? 0 :this.state.Data.adult} </Text>
                            </View>
                        </View>
                        <View style={[styles.departureView,]}>
                            <View style={styles.depCont}>
                            ...
                            <View style={{flex:1}}>
                                <Text style={styles.firstTextVal}>{this.state.Data.child == "0" ? 0 :this.state.Data.child}</Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.departureView}>
                            ...
                            <View style={{flex:1}}>
                                <Text style={styles.firstTextVal}>{this.state.Data.special == "0" ? 0 :this.state.Data.special}</Text>
                            </View>
                        </View>
                        <View style={styles.departureView}>
                            <View style={styles.depCont}>
                            ...
                            <View style={{flex:1}}>
                                <Text style={styles.firstTextVal}>{this.state.Data.total_seat}</Text>
                            </View>
                        </View>
                        <View style={styles.departureView}>
                            <View style={styles.depCont}>
                            ...
                            <View style={{flex:1}}>
                                <Text style={styles.firstTextVal}>{this.state.Data.seat_numbers}</Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.departureView}>
                            ...
                            <View style={{flex:1}}>
                            <Text style={styles.firstTextVal}>{this.state.Data.offer_code == null ? 'Not Any':this.state.Data.offer_code}</Text>
                            </View>
                        </View>
                        <View style={styles.departureView}>
                            <View style={styles.depCont}>
                            ...
                            <View style={{flex:1}}>
                                <Text style={styles.firstTextVal}>{this.state.Data.booking_type}</Text>
                            </View>
                        </View>
                        <View style={styles.departureView}>
                            <View style={styles.depCont}>
